...
class Purchase:
    ...
    def calculate_price(self):
        ...
        if fruit_price>0:
            ...
            price = fruit_price*self.__quantity
            
            if fruit_price == max(FruitInfo.get_fruit_price_list()) and self.__quantity>1:
                price *= 0.98
            if fruit_price == min(FruitInfo.get_fruit_price_list()) and self.__quantity>=5:
                price *= 0.95
...
cust1 = Customer("ABC", "wholesale")
p = Purchase(cust1,"Apple", 10)
