...
class PermanentEmployee(Employee):
    ...
    def identify_performance_hike(self):
        if self.get_performance_list()[-1] == 1:
            if self.get_performance_list()[-2] == 1:
                return 5
            elif self.get_performance_list()[-2] == 2:
                if self.get_performance_list()[-3] == 1:
                    return 3
        else:
            return None
    ...
    def identify_incentive(self):
        return Company.get_c_incentive()+self.get_e_incentive()+self.get_p_incentive()
...
p1 = PermanentEmployee(101, 5000, "A", 50000, [1,2,1,1,1], 6000)
